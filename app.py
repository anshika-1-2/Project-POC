...
#     Handles: 76, "76", "76kcal", "6.2g", "3.9 g", etc.
...
#         numeric = _strip_to_float(val)
#         if numeric is not None:
#             rows.append({"Nutrient":label,"Amount":numeric,"Unit":unit})
#         else:
...
#         other          = [a for a in allergens if not (user_alg and (user_alg in a or a in user_alg))]
#         mandatory      = [a for a in other if a in JP_MANDATORY]
#         recommended    = [a for a in other if a not in JP_MANDATORY]
